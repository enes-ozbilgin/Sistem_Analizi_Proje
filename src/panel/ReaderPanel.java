...
public class ReaderPanel extends JPanel {
	...
	public ReaderPanel(CardLayout cardLayout, JPanel cardPanel) {
        ...
        loginButton.addActionListener(e -> cardLayout.show(cardPanel, "readerLoginPanel"));

        JButton signUpButton = new JButton("Sign Up");
        styleButton(signUpButton);
        signUpButton.addActionListener(e -> cardLayout.show(cardPanel, "readerSignUpPanel"));
